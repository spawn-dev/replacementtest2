...
const IOS_CONFIG_FILE = "./ios/replacementtest2/GoogleService-Info.plist";
...
try {
    ...
    console.log("Error generation Firebase config files for IOS and Android.  Ensure that you have downloaded the serviceAccountKey.json file from https://console.firebase.google.com/project/replacementtest2-22b6f/settings/serviceaccounts/adminsdk  it is at the root of your project directory, and named serviceAccountKey.json")
    process.exit(1)
}
